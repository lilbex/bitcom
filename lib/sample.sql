...
INSERT OR IGNORE INTO `results_agentname` (`name_id`, `firstname`, `lastname`, `email`, `phone`, `pollingunit_uniqueid`) VALUES
...
INSERT OR IGNORE INTO `results_announced_lga_results` (`result_id`, `lga_name`, `party_abbreviation`, `party_score`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
INSERT OR IGNORE INTO `results_announced_pu_results` (`result_id`, `polling_unit_uniqueid`, `party_abbreviation`, `party_score`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
INSERT OR IGNORE INTO `results_lga` (`uniqueid`, `lga_id`, `lga_name`, `state_id`, `lga_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
INSERT OR IGNORE INTO `results_party` (`id`, `partyid`, `partyname`) VALUES
(1, 'PDP', 'PDP'),
(2, 'DPP', 'DPP'),
(3, 'ACN', 'ACN'),
(4, 'PPA', 'PPA'),
...
INSERT OR IGNORE INTO `results_polling_unit` (`uniqueid`, `polling_unit_id`, `ward_id`, `lga_id`, `uniquewardid`, `polling_unit_number`, `polling_unit_name`, `polling_unit_description`, `lat`, `long`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
...
INSERT OR IGNORE INTO `results_states` (`state_id`, `state_name`) VALUES
(1, 'Abuja'),
(2, 'Abia'),
(3, 'Anambra'),
(4, 'Akwa Ibom'),
...
INSERT OR IGNORE INTO `results_ward` (`uniqueid`, `ward_id`, `ward_name`, `lga_id`, `ward_description`, `entered_by_user`, `date_entered`, `user_ip_address`) VALUES
